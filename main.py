...
from graphic_arts_main.start_game_banner import run_screensaver


def attack(char_name: str, char_class: str) -> str:
    """Вычисляет урон от атаки."""
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет урон от специальной атаки."""
    if char_class == 'warrior':
